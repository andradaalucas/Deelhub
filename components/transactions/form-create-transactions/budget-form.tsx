        ...
        <Form {...form}>
          ...
          >
                              ...
                              <TableRow key={index}>
                                ...
                                <TableCell>
                                  <Input
                                    ...
                                    onChange={(e) => {
                                      const updatedServices = [...services];
                                      updatedServices[index].price = parseFloat(
                                        e.target.value,
                                      );
                                      setServices(updatedServices);
                                    }}
                                ...
                                <TableCell>
                                  <Input
                                    ...
                                    onChange={(e) => {
                                      const updatedServices = [...services];
                                      updatedServices[index].hours = parseInt(
                                        e.target.value,
                                      );
                                      setServices(updatedServices);
                                    }}
                                ...
                                <TableCell>
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    onClick={() => removeItem(index, "service")}
                                  >
                                    <X className="h-4 w-4" />
                                  </Button>
                                </TableCell>
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 flex lg:hidden md:hidden items-end justify-end">
                a
              </div>
            </div>
          </form>
